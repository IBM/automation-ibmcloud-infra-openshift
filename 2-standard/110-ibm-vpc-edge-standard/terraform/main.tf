...
module "ext-ingress-subnets" {
  ...
  region = var.region
  resource_group_name = module.vpc_resource_group.name
  tags = var.ext-ingress-subnets_tags == null ? null : jsondecode(var.ext-ingress-subnets_tags)
  vpc_name = module.ibm-vpc.name
...
module "int-ingress-subnets" {
  ...
  region = var.region
  resource_group_name = module.vpc_resource_group.name
  tags = var.int-ingress-subnets_tags == null ? null : jsondecode(var.int-ingress-subnets_tags)
  vpc_name = module.ibm-vpc.name
