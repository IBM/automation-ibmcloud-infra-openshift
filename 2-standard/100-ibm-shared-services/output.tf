...
output "sm-key_id" {
  ...
  value = module.sm-key.id
}
output "sm-key_name" {
  description = "The crn of the key"
  value = module.sm-key.name
}
output "sm-key_crn" {
  description = "The crn of the key"
  value = module.sm-key.crn
}
output "sm-key_kms_id" {
  description = "The id of the kms instance"
  value = module.sm-key.kms_id
}
output "sm-key_kms_public_url" {
  description = "The public url of the kms instance"
  value = module.sm-key.kms_public_url
}
output "sm-key_kms_private_url" {
  description = "The private url of the kms instance"
  value = module.sm-key.kms_private_url
}
output "logdna_id" {
  description = "The id of the provisioned instance."
