...
variable "gitops_repo_integration_server_name" {
  type = string
...
variable "integration_resource_group_name" {
  type = string
  description = "The name of the resource group"
}
variable "integration_resource_group_sync" {
  type = string
...
variable "integration_cluster_name" {
  type = string
...
variable "integration_cluster_flavor" {
  type = string
...
variable "integration_cluster_exists" {
  type = bool
  description = "Flag indicating if the cluster already exists (true or false)"
  default = true
}
variable "integration_cluster_disable_public_endpoint" {
  type = bool
