...
variable "vpc_resource_group_provision" {
  type = bool
  description = "Flag indicating that the resource group should be created"
  default = true
}
...
variable "ibm-vpc_address_prefixes" {
  ...
  default = "[\"10.1.0.0/22\",\"10.2.0.0/22\",\"10.3.0.0/22\"]"
}
